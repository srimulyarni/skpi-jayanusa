...
export default function PengajuanEdit({ pengajuan, kategori }: { pengajuan: PengajuanData; kategori: Kategori[] }) {
    ...
    const [kegiatanList, setKegiatanList] = useState<KegiatanItem[]>(
        pengajuan.detail_pengajuan.map((d) => ({
            kategori_id: String(d.kategori_id),
            nama_kegiatan: d.nama_kegiatan,
            tahun_kegiatan: d.tahun_kegiatan,
            peran: d.peran,
            bukti: null,
...
return;
    ...
    function handleEditItem(index: number) {
        setInputForm({ ...kegiatanList[index] });
        setEditIndex(index);
        setErrors({});
    }
                                        ...
                                        <TableRow key={i}>
                                            ...
                                            <TableCell>
                                                <div className="flex gap-1">
                                                    ...
                                                    <Button size="icon" variant="ghost" onClick={() => handleEditItem(i)}>
