            ...
            <div className="space-y-6 p-4 md:p-6">
                <div className="flex items-center gap-3">
                    <Button variant="outline" size="icon" asChild>
                        <Link href="/validator/jurusan"><ArrowLeft className="h-4 w-4" /></Link>
                    </Button>
                    ...
                    <CardContent className="space-y-4 pt-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select value={form.data.identitas_pt_id} onValueChange={(v) => form.setData('identitas_pt_id', v)}>
                                <SelectTrigger className="w-full"><SelectValue placeholder="Pilih institusi" /></SelectTrigger>
                                <SelectContent>
                                    {identitas.map((pt) => (
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <Button variant="outline" asChild className="w-full sm:w-auto">
                                <Link href="/validator/jurusan">Batal</Link>
                            </Button>
                        </div>
                    </CardContent>
                </Card>
...
JurusanCreate.layout = {
    breadcrumbs: [
        ...
        { title: 'Jurusan', href: '/validator/jurusan' },
        { title: 'Tambah', href: '/validator/jurusan/create' },
    ],
};
