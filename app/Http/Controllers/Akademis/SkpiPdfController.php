...
class SkpiPdfController extends Controller
{
    ...
    {
        $skpi->load(['pengajuan.mahasiswa.jurusan.identitasPt', 'pengajuan.detailPengajuan.kategori', 'identitasPt']);

        return [
            'skpi' => $skpi,
            'mahasiswa' => $skpi->pengajuan->mahasiswa,
            'identitasPt' => $skpi->identitasPt,
            'aktivitas' => $skpi->pengajuan->detailPengajuan,
        ];
    }
}
