...
class IdentitasPtController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('validator/identitas-pt/index', [
            'identitas' => $identitas,
    ...
    {
        return Inertia::render('validator/identitas-pt/create');
    }
    ...
    public function store(IdentitasPtRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('validator.identitas-pt.index')->with('success', 'Identitas PT berhasil ditambahkan.');
    }

    public function edit(IdentitasPt $identitasPt): Response
    {
        return Inertia::render('validator/identitas-pt/edit', [
    ...
    public function update(IdentitasPtRequest $request, IdentitasPt $identitasPt): RedirectResponse
    {
        ...
        return redirect()->route('validator.identitas-pt.index')->with('success', 'Identitas PT berhasil diperbarui.');
    }
