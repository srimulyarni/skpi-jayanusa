...
class JurusanController extends Controller
{
    ...
    {
        return Inertia::render('validator/jurusan/create', [
            'identitas' => IdentitasPt::orderBy('kode_institusi')->select('id', 'kode_institusi', 'nama_singkat')->get(),
        ]);
    }
    ...
    public function store(JurusanRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('validator.jurusan.index')->with('success', 'Jurusan berhasil ditambahkan.');
    }

    public function edit(Jurusan $jurusan): Response
    {
        return Inertia::render('validator/jurusan/edit', [
            'jurusan' => $jurusan,
            'identitas' => IdentitasPt::orderBy('kode_institusi')->select('id', 'kode_institusi', 'nama_singkat')->get(),
        ]);
    }
    ...
    public function update(JurusanRequest $request, Jurusan $jurusan): RedirectResponse
    {
        ...
        return redirect()->route('validator.jurusan.index')->with('success', 'Jurusan berhasil diperbarui.');
    }
